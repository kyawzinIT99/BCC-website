...
const schema = [
  ...
  `CREATE TABLE IF NOT EXISTS community_live_streams (
    ...
    platform VARCHAR(40) NOT NULL, source_url VARCHAR(1000) NOT NULL, embed_url VARCHAR(1500) NOT NULL,
    description TEXT NOT NULL, status VARCHAR(40) NOT NULL DEFAULT 'draft',
    created_by BIGINT UNSIGNED, created_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    updated_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3)
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci`,
