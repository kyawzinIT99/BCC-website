  ...
  "our-work": [
    {
      ...
      alt: "Community members gathered at church",
    },
    {
      url: "/community-story-culture.jpg",
      alt: "Community members celebrating Burmese culture",
    },
    {
...
export const defaultPageMedia: Record<"about" | "our-work", PageMedia> = {
  about: {
    ...
    heroImageAlt:
      "A diverse group preparing welcome and learning materials together in an Australian community setting.",
    featureImages: [
      { url: "", alt: "" },
      { url: "", alt: "" },
      { url: "", alt: "" },
  ...
  "our-work": {
    ...
    heroImageAlt:
      "Young Burmese Catholic community members walking together outdoors in Western Australia.",
