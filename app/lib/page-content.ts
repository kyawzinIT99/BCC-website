...
export const defaultGivingContent: GivingContent = {
  ...
  howToGive:
    "To support BCC WA, contact the community through Get Involved. Payment instructions are shared only through authorised channels after committee approval.",
